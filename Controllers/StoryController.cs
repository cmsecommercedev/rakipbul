...
namespace RakipBul.Controllers
{
    ...
    public class StoryController : Controller
    {
        ...
        public async Task<IActionResult> Create([FromForm] string title, [FromForm] bool published, 
            [FromForm] DateTime startDate,[FromForm] DateTime endDate, [FromForm] IFormFile? storyImage, List<IFormFile> files)
        {
