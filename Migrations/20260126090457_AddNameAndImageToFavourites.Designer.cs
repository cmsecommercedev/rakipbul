...
namespace RakipBul.Migrations
{
    ...
    [Migration("20260126090457_AddNameAndImageToFavourites")]
    partial class AddNameAndImageToFavourites
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MobileVideoStat", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RakipBul.Models.FavouritePlayers", b =>
                {
            ...
            modelBuilder.Entity("RakipBul.Models.RichContentCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RakipBul.Models.Season", b =>
                {
                    b.Property<int>("SeasonID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RakipBul.Models.Story", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RakipBul.Models.StoryContent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Rakipbul.Models.DeviceToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("SubscribedTopic")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Rakipbul.Models.DeviceTopicSubscription", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("DeviceTopicSubscriptions");
                });

            modelBuilder.Entity("Rakipbul.Models.PanoramaEntry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("YoutubeEmbedLink")
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("Id");

                    b.ToTable("PanoramaEntries");
                });

            modelBuilder.Entity("Rakipbul.Models.TeamSquadImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("TeamSquadImages");
                });

            modelBuilder.Entity("Rakipbul.Models.UserDeviceToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Rakipbul.Models.VideoTotalView", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RakipBul.Models.PlayerSuspensions", b =>
                {
                    ...
                    b.HasOne("RakipBul.Models.Season", "Season")
                        .WithMany()
            ...
            modelBuilder.Entity("RakipBul.Models.RichStaticContent", b =>
                {
                    b.HasOne("RakipBul.Models.RichContentCategory", "Category")
            ...
            modelBuilder.Entity("RakipBul.Models.StoryContent", b =>
                {
                    b.HasOne("RakipBul.Models.Story", "Story")
                        .WithMany("Contents")
